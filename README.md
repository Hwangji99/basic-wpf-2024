...
- WPF 개인 토이 프로젝트
    - 부산광역시 119에 구조된 반려동물 찾기 서비스
        ...
        - 성능
            1. 조회 클릭 시
                - 아무것도 입력이 되지않은 상태에서 조회 시 모든 자료가 뜸
                - 조회하고자 하는 종을 입력 후 조회 시 구조된 반려 동물들의 정보가 뜸

            2. 자료를 클릭 시 반려동물의 사진이 뜸

            3. 자료를 클릭 후 미인수건 버튼을 누르면 미인수건으로 따로 저장됨
                - 중복 추가 안됨
...
https://github.com/Hwangji99/basic-wpf-2024/assets/158007430/1943d782-c673-494a-b8ac-650295956642
